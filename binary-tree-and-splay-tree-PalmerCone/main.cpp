...
int main(int argc, char* argv[]){
  ...
  time.start();
  Node *nodeptr = NULL;
  //TODO: put here the constructor of your Splay tree
  SplayTree T;
  for(auto i : values){
    //TODO: call the insert function on your splay tree
    T.insert(i);
  }
  time.stop();
  ...
  time.start();
  for(auto i : values){
      //TODO: call the search function on your splay tree
      T.search(i);
  }
  time.stop();
...
//TODO: print the content of your Splay tree
  T.BinaryTree::inorder(T.getRoot());
